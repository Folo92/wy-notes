[Dangit, Git!?!](https://dangitgit.com/zh) 
...
[噢，糟了，我刚才好像犯了个大错，能不能给我台时光机啊!?!](#magic-time-machine)
----------------------------------------------------
...
[噢，糟了，我刚提交 commit 就发现还有一个小改动需要添加！](#change-last-commit)
-------------------------------------------------------
...
[噢，糟了，我要修改我刚刚 commit 提交的信息！](#change-last-commit-message)
---------------------------------------------------------
...
[噢，糟了，我不小心把本应在新分支上提交的东西提交到了 master!](#accidental-commit-master)
---------------------------------------------------------------
...
[噢，糟了，我把这个 commit 提交错分支了！](#accidental-commit-wrong-branch)
-----------------------------------------------------------
...
[噢，糟了，我想用 diff 命令看下改动内容，但啥都没看到?!](#dude-wheres-my-diff)
-------------------------------------------------------
...
[噢，糟了，我想撤回一个很早以前的 commit！](#undo-a-commit)
------------------------------------------
...
[这些乱七八糟的文件太烦人了, 我放弃啦。（那些 untracked 的文件）](#fuck-this-noise)
----------------------------------------------------------
